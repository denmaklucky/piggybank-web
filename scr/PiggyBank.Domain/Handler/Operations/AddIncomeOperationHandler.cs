...
using OperatonModel = PiggyBank.Model.Models.Entities.Operation;

namespace PiggyBank.Domain.Handler.Operations
{
    public class AddIncomeOperationHandler : BaseHandler<AddOperationCommand>
    {
        public AddIncomeOperationHandler(PiggyContext context, AddOperationCommand command)
